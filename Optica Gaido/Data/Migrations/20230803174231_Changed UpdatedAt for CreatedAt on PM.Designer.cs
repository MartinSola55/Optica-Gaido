...
namespace Optica_Gaido.Data.Migrations
{
    ...
    [Migration("20230803174231_Changed UpdatedAt for CreatedAt on PM")]
    partial class ChangedUpdatedAtforCreatedAtonPM
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Optica_Gaido.Models.GlassFocusType", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Optica_Gaido.Models.Product", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Optica_Gaido.Models.Sale", b =>
                {
                    ...
                    b.Property<long>("GlassFocusTypeID")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Optica_Gaido.Models.SalePaymentMethod", b =>
                {
                    ...
                    b.HasKey("SaleID", "PaymentMethodID", "CreatedAt");
            ...
            modelBuilder.Entity("Optica_Gaido.Models.SimpleSale", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Optica_Gaido.Models.SimpleSalePaymentMethod", b =>
                {
                    b.Property<long>("SimpleSaleID")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("SimpleSaleID", "PaymentMethodID");

                    b.HasIndex("PaymentMethodID");

                    b.ToTable("SimpleSalePaymentMethod");
                });

            modelBuilder.Entity("Optica_Gaido.Models.SimpleSaleProduct", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SimpleSaleID");

                    b.ToTable("SimpleSaleProducts");
                });
            ...
            modelBuilder.Entity("Optica_Gaido.Models.Sale", b =>
                {
                    ...
                    b.HasOne("Optica_Gaido.Models.GlassFocusType", "GlassFocusType")
                        .WithMany("Sales")
                        .HasForeignKey("GlassFocusTypeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Optica_Gaido.Models.SimpleSalePaymentMethod", b =>
                {
                    ...
                    b.HasOne("Optica_Gaido.Models.SimpleSale", null)
                        .WithMany("PaymentMethods")
                        .HasForeignKey("SimpleSaleID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Optica_Gaido.Models.SimpleSaleProduct", b =>
                {
                    b.HasOne("Optica_Gaido.Models.Product", "Product")
                        .WithMany()
