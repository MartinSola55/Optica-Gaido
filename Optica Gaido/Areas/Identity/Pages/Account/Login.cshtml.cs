...
namespace Optica_Gaido.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [DataType(DataType.Password, ErrorMessage = "Ingresa una contraseña válida")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Se ha iniciado sesión");
                ...
                {
                    ModelState.AddModelError(string.Empty, "Email y/o contraseña inválidos");
                    return Page();
                }
            }
